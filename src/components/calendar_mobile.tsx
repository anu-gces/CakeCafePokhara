...
import { CalendarClock, CalendarDays, ChevronLeft, ChevronRight, Plus, RotateCcw, Save } from "lucide-react";
    ...
    <div className="flex flex-col p-4 w-full h-full">
      ...
      <div className="flex justify-between py-2">
        <div className="inline-flex -space-x-px bg-background shadow-sm rounded-md overflow-hidden">
          <Drawer shouldScaleBackground={true} setBackgroundColorOnScale={true} open={open} onOpenChange={setOpen}>
            <DrawerContent>
              <DrawerHeader>
        ...
        <span className="inline-flex -space-x-px bg-background shadow-sm border rounded-md overflow-hidden">
          ...
          <Button variant="outline" onClick={handleToday} className="gap-1 border-0 rounded-none">
            <RotateCcw size={20} />
          </Button>
          <Button
            variant="outline"
