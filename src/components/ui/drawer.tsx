  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "group/drawer-content bg-background fixed z-50 flex h-auto flex-col px-4 focus:outline-0 focus-visible:outline-0 ",
  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        data-slot="drawer-content"
        className={cn(
          "group/drawer-content bg-transparent fixed z-50 flex h-auto border-0 flex-col px-0 focus:outline-0 focus-visible:outline-0 ",
        ...
        {...props}
      >
        <motion.div layout transition={{ duration: 0.3 }} className="bg-background pt-4 rounded-tl-2xl rounded-tr-2xl">
          <div className="hidden group-data-[vaul-drawer-direction=bottom]/drawer-content:block bg-gray-300 dark:bg-muted mx-auto mt-4 rounded-full w-[100px] h-2 shrink-0" />
